...
ACodeHackerCharacter::ACodeHackerCharacter()
{
	...
	FollowCamera = CreateDefaultSubobject<UCHCameraComponent>(TEXT("FollowCamera"));
...
void ACodeHackerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACodeHackerCharacter::Look);
	}
	else
	{
...
void ACodeHackerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACodeHackerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
